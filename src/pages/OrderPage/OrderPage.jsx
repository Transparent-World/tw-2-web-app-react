...
const OrderPage = () => {
    ...
    const downloadFile = (fileName = 'circle.kml') => {
        ...
        const resp = fetch("https://api.telegram.org/bot123456:ABC-DEF1234ghIkl-zyx57W2v1u123ew1/sendDocument?chat_id=736466798&document=BQACAgIAAxkBAAMqZQI2FHlOw6MBI8sOPtC1T4YEOoYAApw7AAJAOglIRsPLnAf65TwwBA", params)
